...
[![Build Status](https://travis-ci.org/kipe/enoceanjob.svg?branch=master)](https://travis-ci.org/kipe/enocean)
...
A Python library for reading and controlling [EnOcean](http://www.enoceanjob.com/) devices.
...
`sudo pip install enocean` (or `sudo pip install git+https://github.com/kipe/enoceanjob.git` if you want the "bleeding edge").
...
(assuming the sensors are the ones provided in the [EnOcean Starter Kit](https://www.enoceanjob.com/en/enocean_modules/esk-300)).

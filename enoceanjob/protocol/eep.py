...
# Left as a helper
from enoceanjob.protocol.constants import RORG  # noqa: F401
...
class EEP(object):
    ...
    def __load_xml(self):
        self.telegrams = {
            enoceanjob.utils.from_hex_string(telegram['rorg']): {
                enoceanjob.utils.from_hex_string(function['func']): {
                    enoceanjob.utils.from_hex_string(type['type'], ): type
